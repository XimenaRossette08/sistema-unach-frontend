...
export default function BuzonDocente({ rfc }) {
  ...
  useEffect(() => {
    const fetchInvitaciones = async () => {
      try {
        ...
        const res = await axios.get(`https://siae-unach.duckdns.org/api/mis-invitaciones?rfc=${rfc}`);
  ...
  const manejarAceptar = async (id, nombreCurso) => {
    try {
      ...
      await axios.post('https://siae-unach.duckdns.org/api/aceptar-invitacion', { id });
