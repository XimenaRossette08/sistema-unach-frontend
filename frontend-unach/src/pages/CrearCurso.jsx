...
export default function CrearCurso() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const msg = err.response?.data?.detail || "Error al publicar el curso. Revisa la conexión con el servidor.";
      alert(`❌ ${msg}`);
    }
  };
      ...
      <div style={cardStyle}>
        ...
        <div style={formGrid}>
          ...
          <div style={inputGroup}>
            ...
            <input name="fecha_inicio" type="date" value={cursoData.fecha_inicio} onChange={handleChange} style={inputStyle} />
          </div>

          <div style={inputGroup}>
            <label style={labelStyle}>Fecha de Término:</label>
            <input name="fecha_fin" type="date" value={cursoData.fecha_fin} onChange={handleChange} style={inputStyle} />
          </div>
